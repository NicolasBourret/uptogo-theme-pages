            ...
            <CardBody>
              ...
              <div className='annual-plan'>
                <div className='plan-price mt-2'>
                  ...
                  <span className='pricing-duration text-body font-medium-1 font-weight-bold ml-25'>/mois</span>
                </div>
              ...
              <Button.Ripple
                color={'primary'}
                outline={item.title !== 'Professionnel'}
                block
              >
                {item.title === 'Essential' && 'Pack 25 annonces'}
                {item.title === 'Professionnel' && 'Pack 50 annonces'}
                {item.title === 'Ultimate' && 'Pack 100 annonces'}
              </Button.Ripple>
            </CardBody>
          </Card>
        </Col>
